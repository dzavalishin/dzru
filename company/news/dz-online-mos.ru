...
<meta content="Mos.ru и эволюция городских сервисов. За счет чего Москва входит в ТОП-5 городов по развитию публичных сервисов, государственных электронных услуг и электронных сервисов." name="description">
<meta property="og:locale" content="ru_RU" />

<link rel="next" href="company/news/dz-online-mos.ru?page=2"/>
</head>
<body>
...
<main>
  <div class="news-detail">
    <div class="news-detail-item">
        <img src="upload/19959216_1356121394436556_4441347872806545735_n.jpg" class="news-detail-item__img">
        <div class="news-detail-item__content">
          <div class="news-detail-item__date">20.10.2017</div>
          <h1> DZ Online: Mos.ru </h1>
<p> Еще 10 лет назад получить все те услуги, которые сегодня оказывает портал pgu.mos.ru, даже в одном вполне физическом окне, - это была фантастика. Сегодня столичный житель может не покидая своего кресла записаться к врачу, поменять паспорт и подать заявление в ЗАГС. </p>
<br>
<p> Для того чтобы электронные государственные сервисы незаметно встроились в быт горожан, потребовалась масштабная работа, в первую очередь, Департамента Информационных технологий город Москвы. Гостем DZ Online стал Дмитрий Иванов - руководитель направления «Городские электронные услуги», который рассказал о том как трансформировать привычные рутинные сервисы в удобную онлайн-форму, решить бюрократические головоломки и объединить ведомства для большой работы по оптимизации, автоматизации и реализации услуг в электронной форме. </p>
<br>
<p> О чем новый выпуск DZ Online? </p>
<ul>
<li>Какой путь проходит услуга прежде, чем попасть на экраны мониторов.</li>
<li>Как проходит синхронизация баз данных различных ведомств.</li>
<li>Экономит ли ДИТ Москвы деньги.</li>
<li>Есть ли предел оцифровке сервисов.</li>
</ul>
<br>
<p>Приятного просмотра!</p>
<p> <iframe width="560" height="315" src="https://www.youtube.com/embed/Y3m7AxfMoX8" frameborder="0" allowfullscreen></iframe> </p>

          <a href="company/news/" class="backward-link">Вернуться в новости</a>
        </div>
    </div>
  </div>
<div class="news-list"><div class="blog_prev_entry">Предыдущая новость:</div><a href="company/news/dz-online-tadviser" class="news-list-item clearfix">
  <span class="news-list-item__left">
    <img src="upload/photo (2).jpg">
  </span>
  <span class="news-list-item__right">
    <span class="news-list-item__date">13.10.2017</span>
    <span class="news-list-item__title">DZ Online: Tadviser</span>
    <span class="news-list-item__text">СМИ как бизнес: тонкая грань между интересами читателей, редакции и монетизацией на примере Tadviser.
</span>
  </span>
</a></div>
</main>
